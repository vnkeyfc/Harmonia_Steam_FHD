...
for _dir in ['SYSCG']:
    ...
    path=rf'C:\Users\Khang\Desktop\CARTAGRA_FHD\files\image\{_dir}.PAK' #pak gốc
    packPAKpath=rf'C:\Users\Khang\Desktop\CARTAGRA_FHD\files\image\{_dir}_NEW' #folder chứa file ảnh đã edit (cz3,cz4)
    packPAKpathdefault=rf'C:\Users\Khang\Desktop\CARTAGRA_FHD\files\image\{_dir}' #folder chứa file ảnh gốc (cz3,cz4)
    newPAKpath=rf'C:\Users\Khang\Desktop\Cartagra_FHD_CHS\image\{_dir}.PAK' #pak mới
